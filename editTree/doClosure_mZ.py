...
cut = "massZ > " + str(binInfo[1]) + " && massZ < " + str(binInfo[2]) + " && \
         (massZErr/massZ) > " + str(massZErr_rel_min) +  " && (massZErr/massZ) < " + str(massZErr_rel_max) 
...
#myFriend = TFile.Open("newtree.root",'read')
#myTree1 = myFriend.Get(treeName)
#myTree.AddFriend("passedEvents","newtree.root")

#myTree.Scan("massZErr:massZErr_corr")
#TProof.Open("")
#c = TChain("myTree")
