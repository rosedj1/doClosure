...
*/
   ...
   float massZErr_corr;
   TFile* f = new TFile("newtree.root","recreate");
   TTree *t3 = new TTree("passedEvents","Reconst ntuple");
   TBranch* newBranch = t3->Branch("massZErr_corr",&massZErr_corr,"massZErr_corr/F");
